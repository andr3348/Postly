...
export function LoginForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-3 bg-white p-8 w-full max-w-[450px] rounded-[20px] shadow-sm mx-auto">
      ...
      <div className="flex flex-row items-center justify-between gap-2.5 mt-2">
        <div className="flex items-center">
          <input type="checkbox" id="remember" className="w-4 h-4 rounded border-gray-300 text-[#2d79f3] focus:ring-[#2d79f3]" />
          <label htmlFor="remember" className="text-[14px] text-gray-700 font-normal ml-2 cursor-pointer">Recordarme</label>
        </div>
        <span className="text-[14px] text-[#2d79f3] font-medium cursor-pointer hover:underline">¿Olvidaste tu contraseña?</span>
      </div>
      ...
      <p className="text-center text-gray-600 text-[14px] my-1.5">
        ...
        <Link href="/register" className="text-[#2d79f3] font-medium cursor-pointer hover:underline">
          Regístrate
        </Link>
      </p>
    </form>
